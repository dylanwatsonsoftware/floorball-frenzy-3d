...
| 4 — ball/action prediction | Explicit owner/state/generation/action metadata, sticky authoritative possession that cannot transfer through incidental overlap, possessed blade following, immediate predicted pass/shot, and stale-snapshot rejection; seeded pass/shot gate passes at 150 ms RTT / 2% loss | Lag-compensated host hit history, pickup accept/reject events, predicted goal presentation, and real-device validation |
