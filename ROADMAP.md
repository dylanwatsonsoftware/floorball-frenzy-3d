...
| --- | --- | --- |
| 1 — diagnostics | In-game FPS/frame/RTT/jitter/loss/snapshot-age/prediction-error HUD plus sent/acknowledged command gap and browser-selected direct/TURN-relay path; deterministic network-condition profiles and seeded schedules | Persistable input/state trace capture and real-device baseline reports |
