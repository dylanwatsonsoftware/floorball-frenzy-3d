...
| 3 — guest reconciliation | Input sequence acknowledgements, outstanding-command replay, timestamped snapshots, remote extrapolation, rotation smoothing, and loss-tolerant immediate dash prediction; seeded movement and dash gates pass at 150 ms RTT / 2% loss | Acknowledge only commands actually simulated by the host, real-device validation, and explicit remote interpolation buffer under bursty delivery |
