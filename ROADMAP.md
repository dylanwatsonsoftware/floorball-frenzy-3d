...
| 4 — ball/action prediction | Explicit owner/state/generation/action metadata, sticky authoritative possession that cannot transfer through incidental overlap, possessed blade following, immediate predicted pass/shot, stale-snapshot rejection, and bounded host transform history for lag-compensated guest slap/pass validation; seeded pass/shot gate passes at 150 ms RTT / 2% loss | Pickup accept/reject events, predicted goal presentation, and real-device validation |
